...
open class PageMenuController: UIViewController {
    ...
    public func moveToViewController(indexPath:IndexPath){
        self.tabView.selectItem(indexPath: indexPath)
    }
        ...
        case .top:
            ...
            case .layoutGuide:
                if #available(iOS 11.0, *) {
                    ...
                    self.tabView.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor,constant: 55).isActive = true
                } else {
